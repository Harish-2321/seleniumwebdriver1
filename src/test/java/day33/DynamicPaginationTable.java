...
public class DynamicPaginationTable {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		*/
		...
		//Showing 1 to 10 of 1482 (149 Pages)
	...
	for(int p=1;p<=5;p++)
	{
		if(p>1)
		{
		WebElement	active_page=driver.findElement(By.xpath("//uI[@class='pagination']//*[text()="+p+"]"));
		active_page.click();
		Thread.sleep(5000);
		}
	}
		...
		for(int r=1;r<=noOfRows;r++)
		{
			...
			String Staus= driver.findElement(By.xpath("//table[@class='table table-bordered table-hover']//tbody//tr["+r+"]/td[5]")).getText();
			
			System.out.println(CustomerName+"\t"+Emails+"\t"+Staus);
